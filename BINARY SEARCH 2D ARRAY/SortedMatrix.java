...
public class SortedMatrix {
    ...
    static int[] binarySearch(int[][] matrix,int rows,int ColStart,int ColEnd,int target){ //this int row saying in which row u r searching
    ...
    static int[]search(int[][] matrix, int target){
        ...
        //check wherter the target is in the col of 2 rows
